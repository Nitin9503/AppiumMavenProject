...
import static TestNG.StaticVariable.invoice_tillCash;
import static TestNG.StaticVariable.OrderNo;
import static TestNG.StaticVariable.Amount;
import static TestNG.StaticVariable.edit_order_invoice;
@Listeners(TestNG.Listener.class)
public class EditOrder extends Loginapp {
	
	public EditOrder() throws IOException {
		super();
